...
class HistoricoMovimentacao(db.Model):
    ...
    acao = db.Column(db.String(50), nullable=False)  # 'Adicionar', 'Atualizar', 'Remover'
    ...
    # Relação correta com Produto
    produto = db.relationship(
        'Produto',
        backref=db.backref('historico', lazy='dynamic'),
        primaryjoin='HistoricoMovimentacao.produto_id == Produto.id'
    )
